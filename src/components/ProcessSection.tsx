...
const ProcessSection = () => {
  return (
    <section id="process" className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      <RadialBurst className="absolute -right-10 top-10 w-52 h-52 pointer-events-none animate-slow-spin" />
      <SlashLines className="absolute -left-10 bottom-0 w-40 h-80 pointer-events-none animate-float" />
